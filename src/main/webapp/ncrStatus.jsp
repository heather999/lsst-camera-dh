...
<display:table name="${ncrTable}" export="true" defaultsort="7" defaultorder="descending" class="datatable" id="hdl" >
    ...
    <display:column title="RootActivity" sortable="true" >${hdl.rootActivityId}</display:column>
    <display:column title="Timestamp" sortable="true" >${hdl.beginTime}</display:column>
